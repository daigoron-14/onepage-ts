...
type RegisterdVideoType = {
  setRegFlag: Function;
  setExtracurricularId: Function;
};

export const ExtracurricularList = (props: RegisterdVideoType) => {
  const { setRegFlag, setExtracurricularId } = props;
    ...
    axios
      ...
      .then((res) => {
        ...
        if (res.data.results.length == 1) {
          ...
          setFirst({
            pk: res.data.results[0]["extra_id"],
            video: res.data.results[0]["extra_file"],
            title: res.data.results[0]["extra_title"],
            sub: res.data.results[0]["extra_get"]
          });
          ...
          setSecond({
            pk: res.data.results[1]["extra_id"],
            video: res.data.results[1]["extra_file"],
            title: res.data.results[1]["extra_title"],
            sub: res.data.results[1]["extra_get"]
          });
          ...
          setThird({
            pk: res.data.results[2]["extra_id"],
            video: res.data.results[2]["extra_file"],
            title: res.data.results[2]["extra_title"],
            sub: res.data.results[2]["extra_get"]
          });
          ...
          setFourth({
            pk: res.data.results[3]["extra_id"],
            video: res.data.results[3]["extra_file"],
            title: res.data.results[3]["extra_title"],
            sub: res.data.results[3]["extra_get"]
          });
          ...
          setFifth({
            pk: res.data.results[4]["extra_id"],
            video: res.data.results[4]["extra_file"],
            title: res.data.results[4]["extra_title"],
            sub: res.data.results[4]["extra_get"]
          });
        }
      })
      .catch((err) => {
          ...
          <table className="table">
            <thead className="table-header">
              <tr className="table-header-row">
                ...
                <th className="table-header-header">
                  <h5 className="table-header-header-text">得たもの</h5>
                </th>
                <th className="table-header-header">
