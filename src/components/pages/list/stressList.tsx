...
type RegisterdStressType = {
  setRegFlag: Function;
  setStressId: Function;
};

export const StressList = (props: RegisterdStressType) => {
  const { setRegFlag, setStressId } = props;
    ...
    axios
      ...
      .then((res) => {
        ...
        if (res.data.results.length == 1) {
          ...
          setFirst({
            pk: res.data.results[0]["stress_id"],
            title: res.data.results[0]["stress_name"]
          });
          ...
          setSecond({
            pk: res.data.results[1]["stress_id"],
            title: res.data.results[1]["stress_name"]
          });
          ...
          setThird({
            pk: res.data.results[2]["stress_id"],
            title: res.data.results[2]["stress_name"]
          });
          ...
          setFourth({
            pk: res.data.results[3]["stress_id"],
            title: res.data.results[3]["stress_name"]
          });
          ...
          setFifth({
            pk: res.data.results[4]["stress_id"],
            title: res.data.results[4]["stress_name"]
          });
        }
      })
      .catch((err) => {
  ...
  return (
    <PersonalList>
      <div className="list">
        <div className="label">
          <h5 className="label-title">ストレス一覧</h5>
            ...
            <thead className="table-header">
              <tr className="table-header-row">
                <th className="table-header-header">
                  <h5 className="table-header-header-text">ストレス</h5>
                </th>
                <th className="table-header-header">
