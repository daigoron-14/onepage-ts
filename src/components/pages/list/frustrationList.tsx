...
type RegisterdVideoType = {
  setRegFlag: Function;
  setFrustrationId: Function;
};

export const FrustrationList = (props: RegisterdVideoType) => {
  const { setRegFlag, setFrustrationId } = props;
    ...
    axios
      ...
      .then((res) => {
        ...
        if (res.data.results.length == 1) {
          ...
          setFirst({
            pk: res.data.results[0]["frustration_id"],
            video: res.data.results[0]["frustration_file"],
            title: res.data.results[0]["frustration_title"],
            sub: res.data.results[0]["frustration_event"]
          });
          ...
          setSecond({
            pk: res.data.results[1]["frustration_id"],
            video: res.data.results[1]["frustration_file"],
            title: res.data.results[1]["frustration_title"],
            sub: res.data.results[1]["frustration_event"]
          });
          ...
          setThird({
            pk: res.data.results[2]["frustration_id"],
            video: res.data.results[2]["frustration_file"],
            title: res.data.results[2]["frustration_title"],
            sub: res.data.results[2]["frustration_event"]
          });
          ...
          setFourth({
            pk: res.data.results[3]["frustration_id"],
            video: res.data.results[3]["frustration_file"],
            title: res.data.results[3]["frustration_title"],
            sub: res.data.results[3]["frustration_event"]
          });
          ...
          setFifth({
            pk: res.data.results[4]["frustration_id"],
            video: res.data.results[4]["frustration_file"],
            title: res.data.results[4]["frustration_title"],
            sub: res.data.results[4]["frustration_event"]
          });
        }
      })
      .catch((err) => {
  ...
  return (
    <VideoList>
      <div className="list">
        <div className="label">
          <h5 className="label-title">挫折一覧</h5>
          <span className="label-span">あなたが経験してきた挫折の一覧です</span>
        </div>
          ...
          <table className="table">
            <thead className="table-header">
              <tr className="table-header-row">
                ...
                <th className="table-header-header">
                  <h5 className="table-header-header-text">イベント</h5>
                </th>
                <th className="table-header-header">
