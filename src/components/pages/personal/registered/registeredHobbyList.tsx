...
type RegisterdHobbyType = {
  setColor: Function;
};

export const RegisteredHobbyList = (props: RegisterdHobbyType) => {
    ...
    axios
      ...
      .then((res) => {
        ...
        if (res.data.results.length == 1) {
          ...
          setFirst({
            pk: res.data.results[0]["hobby_id"],
            title: res.data.results[0]["hobby_name"]
          });
          ...
          setSecond({
            pk: res.data.results[1]["hobby_id"],
            title: res.data.results[1]["hobby_name"]
          });
          ...
          setThird({
            pk: res.data.results[2]["hobby_id"],
            title: res.data.results[2]["hobby_name"]
          });
          ...
          setFourth({
            pk: res.data.results[3]["hobby_id"],
            title: res.data.results[3]["hobby_name"]
          });
          ...
          setFifth({
            pk: res.data.results[4]["hobby_id"],
            title: res.data.results[4]["hobby_name"]
          });
        }
      })
      .catch((err) => {
  ...
  const onClickDetail = (props: number) => {
    axios
      ...
      .then((res) => {
        ...
        navigate("/dashboard/registered/hobby/detail", {
          state: { hobby_id: props }
        });
      })
      .catch((err) => {
  ...
  return (
    <RChronology>
      <div className="list">
        <div className="label">
          <h5 className="label-title">趣味一覧</h5>
          <span className="label-span">あなたの趣味の一覧です。</span>
        </div>
            ...
            <thead className="table-header">
              <tr className="table-header-row">
                <th className="table-header-header">
                  <h5 className="table-header-header-text">趣味</h5>
                </th>
                <th className="table-header-header">
