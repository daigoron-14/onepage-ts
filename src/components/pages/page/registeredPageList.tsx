...
export const RegisteredPageList = (props: RegisterdHobbyType) => {
  ...
  useEffect(() => {
    ...
    axios
      .get(`https://onepage-server.com/onepage/pageu/?page=${page}`, {
        headers: {
      ...
      .then((res) => {
        ...
        if (res.data.results.length == 1) {
          ...
          setFirst({
            ...
            title: res.data.results[0]["page_company"]
          });
          ...
          setSecond({
            ...
            title: res.data.results[1]["page_company"]
          });
          ...
          setThird({
            ...
            title: res.data.results[2]["page_company"]
          });
          ...
          setFourth({
            ...
            title: res.data.results[3]["page_company"]
          });
          ...
          setFifth({
            pk: res.data.results[4]["page_id"],
            title: res.data.results[4]["page_company"]
          });
        }
      })
      .catch((err) => {
  ...
  const onClickDetail = (props: number) => {
    axios
      .get(`https://onepage-server.com/onepage/paged/${props}/`, {
        headers: {
          Authorization: `Token ${token}`
        }
      })
      .then((res) => {
        ...
        navigate("/dashboard/registered/page/detail", {
          state: { page_id: props }
        });
      })
      .catch((err) => {
  ...
  return (
    <RChronology>
      <div className="list">
        <div className="label">
          <h5 className="label-title">ページ一覧</h5>
          <span className="label-span">あなたが作成したページの一覧です。</span>
        </div>
