...
export const RegisteredFrustrationList = (props: RegisterdVideoType) => {
  ...
  const onClickDetail = (props: number) => {
    axios
      ...
      .then((res) => {
        ...
        navigate("/dashboard/registered/frustration/detail", {
          state: { frustration_id: props }
        });
      })
      .catch((err) => {
  ...
  return (
    <RChronology>
      <div className="list">
        <div className="label">
          <h5 className="label-title">挫折経験一覧</h5>
          <span className="label-span">
            あなたが学生時代に経験した挫折の一覧です
          </span>
        </div>
