...
export const RegisteredInterviewList = (props: RegisterdVideoType) => {
  ...
  const onClickDetail = (props: number) => {
    axios
      ...
      .then((res) => {
        ...
        navigate("/dashboard/registered/interview/detail", {
          state: { interview_id: props }
        });
      })
      .catch((err) => {
          ...
          <table className="table">
            <thead className="table-header">
              <tr className="table-header-row">
                ...
                <th className="table-header-header">
                  <h5 className="table-header-header-text">質問者との間柄</h5>
                </th>
                <th className="table-header-header">
