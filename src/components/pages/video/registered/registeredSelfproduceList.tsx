...
export const RegisteredSelfproduceList = (props: RegisterdVideoType) => {
  ...
  const onClickDetail = (props: number) => {
    axios
      ...
      .then((res) => {
        ...
        navigate("/dashboard/registered/selfproduce/detail", {
          state: { selfproduce_id: props }
        });
      })
      .catch((err) => {
