...
export const RegisteredOtherList = (props: RegisterdVideoType) => {
  ...
  const onClickDetail = (props: number) => {
    axios
      ...
      .then((res) => {
        ...
        navigate("/dashboard/registered/other/detail", {
          state: { other_id: props }
        });
      })
      .catch((err) => {
  ...
  return (
    <RChronology>
      <div className="list">
        <div className="label">
          <h5 className="label-title">フリー動画一覧</h5>
